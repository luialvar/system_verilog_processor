...
//func7 + func3 + opcode
localparam [16:0] INST_ADD   = 17'b0000000_000_0110011;
localparam [16:0] INST_ADDI  = 17'b0000000_000_0010011;

localparam [16:0] INST_AND   = 17'b0000000_111_0110011;
localparam [16:0] INST_ANDI  = 17'b0000000_111_0010011;

localparam [16:0] INST_OR    = 17'b0000000_110_0110011;
localparam [16:0] INST_ORI   = 17'b0000000_110_0010011;

localparam [16:0] INST_XOR   = 17'b0000000_100_0110011;
localparam [16:0] INST_XORI  = 17'b0000000_100_0010011;

localparam [16:0] INST_MUL    = 17'b0000001_000_0110011;
//added
localparam [16:0] INST_MULH   = 17'b0000001_001_0110011;
localparam [16:0] INST_MULHSU = 17'b0000001_010_0110011;
localparam [16:0] INST_MULHU  = 17'b0000001_011_0110011;
localparam [16:0] INST_DIV    = 17'b0000001_100_0110011;
localparam [16:0] INST_DIVU   = 17'b0000001_101_0110011;
localparam [16:0] INST_REM    = 17'b0000001_110_0110011;
localparam [16:0] INST_REMU   = 17'b0000001_111_0110011;

localparam [16:0] INST_SLL   = 17'b0000000_001_0110011;
localparam [16:0] INST_SLLI  = 17'b0000000_001_0010011;

localparam [16:0] INST_SRA   = 17'b0100000_101_0110011;
localparam [16:0] INST_SRAI  = 17'b0100000_101_0010011;

localparam [16:0] INST_SRL   = 17'b0000000_101_0110011;
localparam [16:0] INST_SRLI  = 17'b0000000_101_0010011;

localparam [16:0] INST_LW    = 17'b0000000_010_0000011;
localparam [16:0] INST_SW    = 17'b0000000_010_0100011;

localparam [16:0] INST_SLT   = 17'b0000000_010_0110011;
localparam [16:0] INST_SLTI  = 17'b0000000_010_0010011;

localparam [16:0] INST_SLTU  = 17'b0000000_011_0110011;
localparam [16:0] INST_SLTIU = 17'b0000000_011_0010011;

localparam [16:0] INST_JALR  = 17'b0000000_000_1100111;
localparam [16:0] INST_LUI   = 17'b0000000_000_0110111;

localparam [16:0] INST_BEQ   = 17'b0000000_000_1100011;
localparam [16:0] INST_BNE   = 17'b0000000_001_1100011;
localparam [16:0] INST_BLT   = 17'b0000000_100_1100011;
localparam [16:0] INST_BGE   = 17'b0000000_101_1100011;
localparam [16:0] INST_BLTU  = 17'b0000000_110_1100011;
localparam [16:0] INST_BGEU  = 17'b0000000_111_1100011;

localparam [16:0] INST_MRET  = 17'b0011000_000_1110011;
localparam [16:0] INST_CSRR  = 17'b0000000_010_1110011;
localparam [16:0] INST_CSRW  = 17'b0000000_001_1110011;
...
module alu_tb;
  ...
  initial
    begin
      ...
      // MULH (signed x signed) -> upper 32 bits BONUS
      test_vectors.push_back({32'h00000011, 32'h00000003, 32'h00000000, INST_MULH,   1'b0});  // MULH: 17*3 = 0x...00000033 -> high=0
      test_vectors.push_back({32'hFFFFFFFF, 32'h00000002, 32'hFFFFFFFF, INST_MULH,   1'b0});  // MULH: (-1)*2 = 0xFFFFFFFFFFFFFFFE -> high=FFFFFFFF
      test_vectors.push_back({32'h80000000, 32'h00000002, 32'hFFFFFFFF, INST_MULH,   1'b0});  // MULH: (-2^31)*2 = 0xFFFFFFFF00000000 -> high=FFFFFFFF
      test_vectors.push_back({32'h7FFFFFFF, 32'h7FFFFFFF, 32'h3FFFFFFF, INST_MULH,   1'b0});  // MULH: (2^31-1)^2 = 0x3FFFFFFF00000001 -> high=3FFFFFFF

      // MULHSU (signed rs1 x unsigned rs2) -> upper 32 bits BONUS
      test_vectors.push_back({32'hFFFFFFFF, 32'h00000002, 32'hFFFFFFFF, INST_MULHSU, 1'b0});  // MULHSU: (-1)*2 = 0xFFFFFFFFFFFFFFFE -> high=FFFFFFFF
      test_vectors.push_back({32'hFFFFFFFF, 32'hFFFFFFFF, 32'hFFFFFFFF, INST_MULHSU, 1'b0});  // MULHSU: (-1)*(2^32-1)=0xFFFFFFFF00000001 -> high=FFFFFFFF
      test_vectors.push_back({32'h80000000, 32'h00000002, 32'hFFFFFFFF, INST_MULHSU, 1'b0});  // MULHSU: (-2^31)*2 = 0xFFFFFFFF00000000 -> high=FFFFFFFF
      test_vectors.push_back({32'h7FFFFFFF, 32'hFFFFFFFF, 32'h7FFFFFFE, INST_MULHSU, 1'b0});  // MULHSU: (2^31-1)*(2^32-1)=0x7FFFFFFE80000001 -> high=7FFFFFFE

      // MULHU (unsigned x unsigned) -> upper 32 bits BONUS
      test_vectors.push_back({32'h00000011, 32'h00000003, 32'h00000000, INST_MULHU,  1'b0});  // MULHU: 17*3 -> high=0
      test_vectors.push_back({32'hFFFFFFFF, 32'h00000002, 32'h00000001, INST_MULHU,  1'b0});  // MULHU: (2^32-1)*2 = 0x00000001FFFFFFFE -> high=1
      test_vectors.push_back({32'h80000000, 32'h00000002, 32'h00000001, INST_MULHU,  1'b0});  // MULHU: 2^31*2 = 0x0000000100000000 -> high=1
      test_vectors.push_back({32'hFFFFFFFF, 32'hFFFFFFFF, 32'hFFFFFFFE, INST_MULHU,  1'b0});  // MULHU: (2^32-1)^2 = 0xFFFFFFFE00000001 -> high=FFFFFFFE
