...
always_ff @( posedge clk ) begin 
    if(reset) begin 
        ...
        if(write_en) begin 
            ...
            /*case({mip[11], mie[11], mip[7], mie[7], exceptions})
                7'b11XXXXX: mcause <= {1'b1, 27'b0, 4'b1011};   //d'11, in mie: MEIE, machine external interrupt enable
                7'bXX11XXX: mcause <= {1'b1, 28'b0, 3'b111};    //d'7, in mie: MTIE, machine timer interrupt enable
                7'bXXXXX1X: mcause <= {30'b0, 2'b10};           //d'2, illegal instruction
                7'bXXXXXX1: mcause <= 32'b0;                    //d'0, pc misaligned
                7'bXXXX1XX: mcause <= {29'b0, 3'b101};          //d'5, load access fault
