...
* address: [23 .tag. 12|11 .index. 5|4 .offset. 2|1 .bytes. 0]
*          [   15      |     7      |     3      |     2     ]
*/

module id_cache_direct_mapped_large (
    input logic clk,
...
logic [31:0] i_cache[2**10];//[128][8];   
logic [c_end:0] i_control[2**7];

logic [31:0] d_cache[2**10];//[128][8];   
logic [c_end:0] d_control[2**7];
