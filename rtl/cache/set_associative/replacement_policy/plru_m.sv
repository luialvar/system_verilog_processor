...
module plru_m #(
    ...
    output logic [way_bits - 1:0] way_replace, // the set that should be replaced
...
//priority encoder?
//determine idex of the first 0-bit in current MRU bits. This index is the next way that should be replaced
always_comb begin
    way_replace = 0;
    carry = 1;
    if(current[0]) begin
